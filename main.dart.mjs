...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1297: x0 => x0.call(),
      _1327: x0 => globalThis.firebase_firestore.getDoc(x0),
      _1328: x0 => globalThis.firebase_firestore.getDocFromServer(x0),
      _1329: x0 => globalThis.firebase_firestore.getDocFromCache(x0),
      ...
      _1334: (x0,x1,x2) => globalThis.firebase_firestore.onSnapshot(x0,x1,x2),
      ...
      _1367: x0 => globalThis.firebase_firestore.increment(x0),
      ...
      _1394: () => globalThis.firebase_firestore.updateDoc,
      ...
      _1526: x0 => globalThis.firebase_core.getApp(x0),
      _1527: () => globalThis.firebase_core.getApp(),
      _1529: () => globalThis.firebase_core.SDK_VERSION,
      _1535: x0 => x0.apiKey,
      _1537: x0 => x0.authDomain,
      _1539: x0 => x0.databaseURL,
      _1541: x0 => x0.projectId,
      _1543: x0 => x0.storageBucket,
      _1545: x0 => x0.messagingSenderId,
      _1547: x0 => x0.measurementId,
      _1549: x0 => x0.appId,
      _1551: x0 => x0.name,
      _1552: x0 => x0.options,
      _1553: (x0,x1) => x0.createElement(x1),
      _1554: (x0,x1) => x0.debug(x1),
      ...
      _1557: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1558: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1559: (x0,x1) => x0.createScriptURL(x1),
      _1560: (x0,x1,x2) => x0.createScript(x1,x2),
      _1561: (x0,x1) => x0.appendChild(x1),
      _1562: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1562(f,arguments.length,x0) }),
      _1564: Date.now,
      _1566: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1567: s => {
      ...
      _1569: () => typeof dartUseDateNowForTicks !== "undefined",
      _1570: () => 1000 * performance.now(),
      _1571: () => Date.now(),
      _1574: () => new WeakMap(),
      _1575: (map, o) => map.get(o),
      _1576: (map, o, v) => map.set(o, v),
      _1577: x0 => new WeakRef(x0),
      _1578: x0 => x0.deref(),
      _1585: () => globalThis.WeakRef,
      _1588: s => JSON.stringify(s),
      _1589: s => printToConsole(s),
      ...
      _1607: a => a.pop(),
      _1608: (a, i) => a.splice(i, 1),
      _1609: (a, s) => a.join(s),
      _1610: (a, s, e) => a.slice(s, e),
      _1613: a => a.length,
      _1615: (a, i) => a[i],
      _1616: (a, i, v) => a[i] = v,
      _1618: o => {
      ...
      _1619: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1621: o => o instanceof Uint8Array,
      _1622: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1623: o => o instanceof Int8Array,
      _1624: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1625: o => o instanceof Uint8ClampedArray,
      _1626: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1627: o => o instanceof Uint16Array,
      _1628: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1629: o => o instanceof Int16Array,
      _1630: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1631: o => o instanceof Uint32Array,
      _1632: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1633: o => o instanceof Int32Array,
      _1634: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1636: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1637: o => o instanceof Float32Array,
      _1638: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1639: o => o instanceof Float64Array,
      _1640: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1641: (t, s) => t.set(s),
      ...
      _1693: () => new AbortController(),
      _1694: x0 => x0.abort(),
      _1695: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1696: (x0,x1) => globalThis.fetch(x0,x1),
      _1697: (x0,x1) => x0.get(x1),
      _1698: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1698(f,arguments.length,x0,x1,x2) }),
      _1699: (x0,x1) => x0.forEach(x1),
      _1700: x0 => x0.getReader(),
      _1701: x0 => x0.read(),
      _1702: x0 => x0.cancel(),
      _1720: x0 => x0.trustedTypes,
      _1721: (x0,x1) => { x0.text = x1 },
      _1733: (s, m) => {
        try {
      ...
      _1749: o => o.length,
      _1751: (o, i) => o[i],
      _1752: f => f.dartFunction,
      _1753: () => ({}),
      _1754: () => [],
      _1756: () => globalThis,
      _1757: (constructor, args) => {
      ...
      _1759: (o, p) => o[p],
      _1760: (o, p, v) => o[p] = v,
      _1761: (o, m, a) => o[m].apply(o, a),
      _1763: o => String(o),
      _1764: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1765: o => {
      ...
      _1766: o => [o],
      _1767: (o0, o1) => [o0, o1],
      _1768: (o0, o1, o2) => [o0, o1, o2],
      _1769: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1774: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _1783: x0 => x0.index,
      _1785: x0 => x0.flags,
      _1786: x0 => x0.multiline,
      _1787: x0 => x0.ignoreCase,
      _1788: x0 => x0.unicode,
      _1789: x0 => x0.dotAll,
      _1790: (x0,x1) => { x0.lastIndex = x1 },
      _1791: (o, p) => p in o,
      _1792: (o, p) => o[p],
      _1793: (o, p, v) => o[p] = v,
      _1794: (o, p) => delete o[p],
      _1795: x0 => x0.random(),
      ...
      _3214: (x0,x1) => { x0.type = x1 },
      _3222: (x0,x1) => { x0.crossOrigin = x1 },
      _3224: (x0,x1) => { x0.text = x1 },
      _3681: () => globalThis.window,
      _4006: x0 => x0.trustedTypes,
      _6288: x0 => x0.signal,
      _6362: () => globalThis.document,
      _6446: x0 => x0.head,
      _8128: x0 => x0.value,
      _8130: x0 => x0.done,
      _8832: x0 => x0.url,
      ...
      _8838: x0 => x0.body,
      _12466: x0 => x0.name,
      _13184: () => globalThis.console,
      _13212: x0 => x0.name,
      _13213: x0 => x0.message,
      _13214: x0 => x0.code,
